...
WEEK 1 — THE FURNACE IS CHANGING

A customer asks:

"I heard the Avilés plant is changing its furnace. What difference will that actually make?"

Which answer is the strongest professional response?
    `,

    choices: [
      {
        text: "It is changing because sustainability is very important nowadays.",
        next: "scene1_retry"
      },
      {
        text: "The main change is a highly electrified hybrid furnace designed to reduce direct CO₂ emissions while maintaining industrial-scale flat-glass production.",
        next: "scene2_fib"
      },
      {
        text: "The old furnace is bad, so the company is replacing it with a better one.",
        next: "scene1_retry"
      },
      {
        text: "It means the finished glass will automatically have better technical performance.",
        next: "scene1_retry"
      }
    ]
  },
  ...
  scene1_retry: {
    ...
    text: `
A strong professional answer should explain:

• WHAT is changing;
• WHY it matters;
• what the expected benefit is.

Avoid vague statements and unsupported claims about product performance.
...
Complete the explanation.
    ...
    sentence: [
      "The new furnace is designed",
      "__________",
      "reduce direct emissions and may result",
      "__________",
      "lower natural-gas consumption. The project also builds",
      "__________",
      "previous electrification trials."
    ],
  ...
  scene3: {
    ...
    text: `
Which sentence best explains HOW a process change creates a result?
    `,

    choices: [
      {
        text: "The plant changes the furnace because lower emissions.",
        next: "scene3_retry"
      },
      {
        text: "The furnace is more electrical for reducing gas.",
        next: "scene3_retry"
      },
      {
        text: "The company is changing the furnace due sustainability.",
        next: "scene3_retry"
      },
      {
        text: "By electrifying more of the melting process, the plant can reduce its dependence on natural gas.",
        next: "scene4_article"
      }
    ]
  },
...
BY + -ING = explain HOW something is achieved.

Example:

By electrifying more of the process, the plant can reduce its dependence on natural gas.
...
Try again.
  ...
  scene4_article: {
    ...
    text: `
READING — THE AVILÉS FURHY PROJECT

Read the Saint-Gobain announcement.

Focus on:

• what is being replaced;
• what makes the new furnace different;
• the relationship with the earlier VOLTA project;
• what Saint-Gobain says about lower-carbon solutions;
• why the project could matter commercially as well as technically.
...
Open the article in a separate tab, then return here.
    ...
    choices: [
      {
        text: "Open article ↗",
        url: "https://www.saint-gobain.com/en/news/saint-gobain-and-agc-partner-innovate-large-scale-highly-electrified-furnace-cut-co2-emissions",
        target: "_blank"
      },
      {
  ...
  scene5: {
    ...
    text: `
According to the article, what will happen at the Avilés site?
    `,

    choices: [
      {
        text: "The existing flat-glass furnace will be replaced by a large-scale highly electrified hybrid furnace.",
        next: "scene6"
      },
      {
        text: "The entire Avilés plant will be closed and production moved abroad.",
        next: "scene5_retry"
      },
      {
        text: "The plant will stop producing flat glass and move exclusively into insulation.",
        next: "scene5_retry"
      },
      {
        text: "The existing furnace will remain unchanged while a pilot furnace is installed elsewhere in Spain.",
        next: "scene5_retry"
      }
    ]
  },
  ...
  scene5_retry: {
    ...
    text: `
The project concerns the replacement of the existing furnace at the Avilés flat-glass plant.

Check the article again if necessary.
    `,
  ...
  scene6: {
    ...
    text: `
Why is the earlier VOLTA project important in the article?
    `,

    choices: [
      {
        text: "It proves that every type of glass can already be produced without any combustion.",
        next: "scene6_retry"
      },
      {
        text: "It was the name of the original Avilés furnace.",
        next: "scene6_retry"
      },
      {
        text: "It provided experience with a smaller electrified pilot furnace before moving toward large-scale deployment.",
        next: "scene7"
      },
      {
        text: "It was a customer survey used to measure demand for architectural glass.",
        next: "scene6_retry"
      }
    ]
  },
...
The article presents VOLTA as an earlier, smaller pilot project that helped develop experience before the larger Avilés deployment.
...
"So this is mainly an environmental project, right?"

Which response adds the strongest commercial perspective?
    `,

    choices: [
      {
        text: "Yes. Environmental issues are the only reason for the investment.",
        next: "scene7_retry"
      },
      {
        text: "Not entirely. Lower-carbon production can also help respond to customers whose projects include stricter sustainability or embodied-carbon requirements.",
        next: "scene8_scramble"
      },
      {
        text: "Yes. Customers are normally interested only in emissions and not in performance.",
        next: "scene7_retry"
      },
      {
        text: "Not really. Production emissions have no relevance to construction customers.",
        next: "scene7_retry"
      }
    ]
  },
  ...
  scene7_retry: {
    ...
    text: `
A Solutions Manager should connect technical change to CUSTOMER VALUE.

The environmental improvement may also matter commercially when customers have sustainability or carbon requirements.
...
Try again.
  ...
  scene8_scramble: {
    ...
    text: `
Build ONE complete professional sentence.
    `,

    scramble: [
      "without changing the required product specifications.",
      "can support customers with demanding sustainability targets",
  ...
  scene9_hangman: {
    ...
    hint: "Recycled or waste glass that can be returned to the glass-manufacturing process as a raw material.",
  ...
  scene9_retry: {
    ...
    text: `
The target is a core glass-industry term for recycled or waste glass that can be reused as a raw material.
...
Complete the explanation.
    ...
    sentence: [
      ...
      "__________",
      "raw materials and support a less",
      "__________",
      "production process."
    ],
  ...
  scene11_video: {
    ...
    youtube: "https://www.youtube.com/watch?v=5PZeDMi7EIo",

    text: `
VIDEO — GLASS RECYCLING INNOVATION

Watch the full short video.

Listen for:

• what happens to waste glass;
• how recycled glass can become a useful construction input;
• how circularity is connected with environmental performance;
• why recycling is presented as a practical industrial solution.
...
Then answer the questions.
    ...
    questions: [
      {
        text: "What problem does the speaker highlight?",
        options: [
          "Most glass already returns to high-value manufacturing loops.",
          "A large share of glass is still sent to landfill instead of being recycled.",
          "Recycled glass cannot be used in construction products.",
          "Glass can only be recycled once."
        ],
        correct: 1
      },
      {
        text: "How is recycled glass presented?",
        options: [
          "As a lower-quality material that customers must accept for environmental reasons.",
          "As a temporary material used only when virgin inputs are unavailable.",
          "As a material mainly intended for decorative applications.",
          "As a useful input that can support lower-carbon construction solutions."
        ],
        correct: 3
      },
      {
        text: "Which statement best summarises the circularity argument?",
        options: [
          "Waste materials can be brought back into productive use while performance requirements are still maintained.",
          "Circularity mainly means producing fewer types of construction products.",
          "The best way to reduce waste is to stop specifying glass.",
          "Recycling is only useful when energy prices are particularly high."
        ],
        correct: 0
      }
    ],
...
"I understand recycling sounds good, but why should I care where the raw material comes from if the final product performs properly?"
...
Which answer is strongest?
    ...
    choices: [
      {
        text: "Because recycled materials are always cheaper than virgin raw materials.",
        next: "scene12_retry"
      },
      {
        text: "Because virgin raw materials should no longer be used in modern construction.",
        next: "scene12_retry"
      },
      {
        text: "Because recycled content can help reduce raw-material consumption and environmental impact while the product still has to meet the required performance criteria.",
        next: "scene13_scramble"
      },
      {
        text: "Because customers are required to choose recycled products in every construction project.",
        next: "scene12_retry"
      }
    ]
  },
...
The strongest answer connects circularity with reduced resource use while keeping PERFORMANCE REQUIREMENTS separate.
...
Try again.
  ...
  scene13_scramble: {
    ...
    text: `
Build ONE complete customer-facing sentence.
    `,

    scramble: [
      "the finished product must still meet",
      "Using more recycled material can reduce demand for virgin resources,",
...
"If the glass has a lower carbon footprint, does that mean it is also stronger or more thermally efficient?"
...
Choose the best response.
    ...
    choices: [
      {
        text: "Yes. A lower carbon footprint normally means better thermal and structural performance.",
        next: "scene14_retry"
      },
      {
        text: "Not necessarily. Carbon footprint describes environmental impact, while strength and thermal performance depend on the technical specification of the product.",
        next: "scene15"
      },
      {
        text: "No. Lower-carbon glass is normally weaker because less energy is used.",
        next: "scene14_retry"
      },
      {
        text: "It depends entirely on how much recycled glass the furnace uses.",
        next: "scene14_retry"
      }
    ]
  },
  ...
  scene14_retry: {
    ...
    text: `
Separate ENVIRONMENTAL PERFORMANCE from TECHNICAL PERFORMANCE.

A lower-carbon production route does not automatically change properties such as strength, insulation or solar-control performance.
...
Try again.
  ...
  scene15: {
    ...
    text: `
A client is sceptical:

"All companies say their products are more sustainable now. Why should I believe this is different?"

Which response is most credible?
    `,

    choices: [
      {
        text: "Because Saint-Gobain is one of the biggest companies in the industry.",
        next: "scene15_retry"
      },
      {
        text: "Because sustainability claims from major manufacturers are normally reliable.",
        next: "scene15_retry"
      },
      {
        text: "Because this project is not just a marketing claim: it involves a specific industrial change to the melting process and builds on earlier electrification trials.",
        next: "scene16_fib"
      },
      {
        text: "Because customers should trust the supplier's environmental strategy.",
        next: "scene15_retry"
      }
    ]
  },
  ...
  scene15_retry: {
    ...
    text: `
The most convincing answer uses EVIDENCE.

Instead of asking the customer to trust a claim, explain the specific industrial change behind it.
...
Complete the explanation.
    ...
    sentence: [
      "From a customer",
      "__________",
      ", the important point is not simply that the furnace uses more electricity. The change is intended to reduce direct emissions,",
      "__________",
      "support customers working toward lower-carbon construction targets",
      "__________",
      "compromising the required product performance."
    ],
  ...
  scene17: {
    ...
    text: `
Which explanation is the clearest for a NON-TECHNICAL customer?
    `,

    choices: [
      {
        text: "The electrification ratio modifies the energy vector of the melting stage.",
        next: "scene17_retry"
      },
      {
        text: "The melter architecture creates a decarbonised transformation of the primary thermal input.",
        next: "scene17_retry"
      },
      {
        text: "More of the melting process will use electricity instead of conventional fuel, which can reduce direct emissions from production.",
        next: "scene18_grammar_run"
      },
      {
        text: "The process undergoes an energy-transition optimisation related to melting technology.",
        next: "scene17_retry"
      }
    ]
  },
  ...
  scene17_retry: {
    ...
    text: `
Technical accuracy is important, but a Solutions Manager also needs CLARITY.

Prefer simple cause-and-effect language when the listener is not a glass-production specialist.
...
scene18_grammar_run: {
  ...
  questions: [
    {
      prompt: "The new furnace is designed ___ reduce direct emissions.",
      answers: ["to"],
      hint: "(for / by / to)"
    },
    {
      prompt: "Emissions can be reduced ___ electrifying more of the melting process.",
      answers: ["by"],
      hint: "(for / by / due)"
    },
    {
      prompt: "The change may result ___ lower natural-gas consumption.",
      answers: ["in"],
      hint: "(in / on / at)"
    },
    {
      prompt: "The FurHy project builds ___ the earlier VOLTA pilot.",
      answers: ["on"],
      hint: "(from / at / on)"
    },
    {
      prompt: "The new system will replace the ___ furnace at Avilés.",
      answers: ["existing"],
      hint: "(existence / existing / existed)"
    },
    {
      prompt: "The process aims to lower emissions ___ maintaining industrial-scale production.",
      answers: ["while"],
      hint: "(while / because / during)"
    },
    {
      prompt: "Using more cullet can reduce dependence ___ virgin raw materials.",
      answers: ["on"],
      hint: "(from / of / on)"
    }
  ]
...
Try the Grammar Run again.
  ...
  scene19: {
    ...
    text: `
FINAL CLIENT CHALLENGE

You need to explain the project in an email.

Which structure would make your message easiest for the customer to follow?
    `,

    choices: [
      {
        text: "Technical details → unrelated sustainability claims → greeting → conclusion",
        next: "scene19_retry"
      },
      {
        text: "Greeting → customer relevance → unrelated production history → technical vocabulary",
        next: "scene19_retry"
      },
      {
        text: "Greeting → what is changing → why it matters → customer relevance → clear conclusion",
        next: "scene20_email"
      },
      {
        text: "Greeting → list of technical terms → environmental slogans → conclusion",
        next: "scene19_retry"
      }
    ]
  },
  ...
  scene19_retry: {
    ...
    text: `
For a customer update, keep the logic simple:

1. What is changing?
2. Why?
3. What is the expected result?
4. Why should the customer care?
...
A customer has asked what the planned Avilés furnace project means from a sustainability perspective.
...
• one expected environmental benefit;
• the relationship with the earlier pilot project;
• why the change may matter to customers.

Use at least FOUR of these naturally:
...
Do not claim that lower-carbon production automatically improves the technical performance of the finished glass.

Aim for clear customer-facing English rather than highly technical language.
    `,

    teacherEmail: "xavier.benitz@gmail.com",
    emailSubject: "Crystal Clear Solutions — Avilés Furnace Update",
    emailBody: "",

    next: "scene20_email_sent"
  },
...
You have moved from technical information to a clear customer-facing explanation.
    `,
...
case 'video-multi-audio-choice':
  req(
    (typeof sc.videoSrc === 'string' && sc.videoSrc.length) ||
    (
      (
        t === 'video' ||
        t === 'video-scramble' ||
        t === 'video-fill-in-the-blank' ||
        t === 'video-multi-question'
      ) &&
      typeof sc.youtube === 'string' &&
      sc.youtube.length
    ),
    id,
    `${t} needs videoSrc`
  ...
  if (t === 'video-multi-question') {
    w(
      Array.isArray(sc.questions) && sc.questions.length,
      id,
      'video-multi-question expects questions[]'
    );
  }
  ...
  break;
      ...
      case 'email':
        req(
          typeof sc.teacherEmail === 'string' &&
          sc.teacherEmail.includes('@'),
          id,
          'needs teacherEmail'
        );
        req(
          typeof sc.emailSubject === 'string',
          id,
          'needs emailSubject'
        );
        break;
...
// ============================================================
// GLOBAL SCENE HISTORY / BACK NAVIGATION
// ============================================================

window.__sceneHistory = window.__sceneHistory || [];
window.__sceneHistoryGoingBack = false;


function ensureGameBackButton() {

  let btn = document.getElementById("game-back-button");

  if (!btn) {

    btn = document.createElement("button");

    btn.id = "game-back-button";
...
`;
  ...
  const canGoBack =
    Array.isArray(window.__sceneHistory) &&
    window.__sceneHistory.length > 0;


  btn.disabled = !canGoBack;
  btn.style.display = canGoBack ? "block" : "none";
  btn.style.opacity = canGoBack ? "1" : "0.4";
}
...
window.goBackScene = function() {
  ...
  // Find the latest valid previous scene.
  ...
  if (!previousId) {
    ...
    console.log(
      "[history] No previous scene available."
    );

    ensureGameBackButton();
  ...
  // Prevent loadScene() from putting the scene
  // we are leaving straight back into history.
  window.__sceneHistoryGoingBack = true;
...
// ============================================================
// SCENE HISTORY
// Store the scene we are LEAVING before changing currentSceneId.
// Do not do this when navigation came from the Back button.
// ============================================================

if (
  !window.__sceneHistoryGoingBack &&
  currentSceneId &&
  currentSceneId !== id &&
...
// Ensure the engine's canonical choices container always exists.
// Some challenge loaders temporarily remove/rebuild it.
let choicesDiv = document.getElementById("choices-container");

if (!choicesDiv && gameContainer) {
  choicesDiv = document.createElement("div");
  choicesDiv.id = "choices-container";
  gameContainer.appendChild(choicesDiv);

  console.log("[UI] Restored missing choices-container");
}
// Always restore the canonical styling class
if (choicesDiv) {
  choicesDiv.classList.add("decision-buttons");
}
...
if (videoElem) {
  ...
  if ("src" in videoElem) {
    try { videoElem.src = ""; } catch(_) {}
  }

  if (typeof videoElem.load === "function") {
    try { videoElem.load(); } catch(_) {}
  }
...
btn.disabled = !available;
  ...
  try {
    if (choice.applyCrm) {
      window.crm && window.crm.apply(choice.applyCrm);
    }
  } catch (e) {
    console.warn('CRM apply (choice) failed', e);
  }

  // Open external resource in a new tab if provided
  if (choice.url) {
    window.open(
      choice.url,
      "_blank",
  ...
  // Continue through the game only if a next scene exists
  if (choice.next) {
  ...
  // Restart scene-enter animation now that the new choice buttons exist
playSceneTransition();
...
function loadVideoScene(id) {
  ...
  if (!scene) { console.error(`Scene ${id} not found.`); return; }
    ...
    console.log("[YT TEST] loadVideoScene called:", id, scene);
  console.log("[YT TEST] youtube value:", scene.youtube);
  ...
  // ============================================================
  // YOUTUBE ADDITION
  // Existing MP4 behaviour remains the default.
  // A scene only uses YouTube when it contains:
  //
  // youtube: "VIDEO_ID"
  //
  // Full YouTube URLs are also accepted.
  // ============================================================

  const isYouTube = !!scene.youtube;

  console.log("[YT TEST] isYouTube:", isYouTube);

  let video = null;
  let youtubePlayer = null;
  let youtubeHost = null;
  let youtubeDestroyed = false;
  ...
  function ensureYouTubeAPI() {
    ...
    // Another YouTube scene already started loading it
    ...
    window.__youtubeIframeApiPromise = new Promise((resolve, reject) => {
      ...
      window.onYouTubeIframeAPIReady = function() {
        ...
        // Preserve another callback if the engine/site already had one
        try {
      ...
      // Do not insert the script twice
      if (!document.querySelector('script[src="https://www.youtube.com/iframe_api"]')) {
        ...
        tag.onerror = function() {
          console.error("[video] YouTube IFrame API failed to load.");
  ...
  function disableSceneVideo() {

    if (isYouTube) {

      if (youtubeHost) {
        youtubeHost.style.pointerEvents = "none";
        youtubeHost.style.opacity = "0.25";
  ...
  if (isYouTube) {
    ...
    // YouTube gets a container instead of an HTML <video>.
    youtubeHost = document.createElement("div");
    youtubeHost.id = "scene-video";

    youtubeHost.style.maxWidth = "100%";
    youtubeHost.style.height = "min(420px, 56.25vw)";
    youtubeHost.style.minHeight = "240px";
    youtubeHost.style.display = "block";
    youtubeHost.style.margin = "0 auto 16px";
    youtubeHost.style.borderRadius = "12px";
    youtubeHost.style.backgroundColor = "black";
    youtubeHost.style.overflow = "hidden";

    const youtubeInner = document.createElement("div");
    youtubeInner.id = "youtube-player-" + String(id).replace(/[^a-zA-Z0-9_-]/g, "_");

    youtubeHost.appendChild(youtubeInner);

    regNode(youtubeHost);
    game.appendChild(youtubeHost);


    const youtubeVideoId = getYouTubeId(scene.youtube);

    ensureYouTubeAPI()
      .then(() => {

        // Scene may have been left while API was loading
        if (youtubeDestroyed) return;
        if (!document.getElementById(youtubeInner.id)) return;

        youtubePlayer = new YT.Player(youtubeInner.id, {
          ...
          events: {
            ...
            onReady: function() {
              ...
              // This mirrors the existing MP4 behaviour.
            },
      ...
      .catch(err => {
        console.warn("[video] YouTube setup failed:", err);
      });
  ...
  function buildChoicesPanel(fromScene) {
    ...
    const rawSec =
      (typeof choicesSrc.timer === "number" || choicesSrc.timer === true)
        ? choicesSrc.timer
        : scene.timer;
    ...
    if (seconds) {
      ...
      timerDiv.style.cssText =
        "font-weight:700;font-size:1.05rem;color:#00ffff;margin:8px 0;";
      ...
      const render = () => {
        ...
        if (timerDiv) {
          ...
          timerDiv.textContent =
            `⏳ Time left: ${Math.max(0,timeLeft)}s${paused?' (paused)':''}`;
    ...
    window.SceneTimer = {
      ...
      pause: () => {
        ...
        if (timerDiv) {
          timerDiv.textContent =
            `⏳ Time left: ${Math.max(0,timeLeft)}s (paused)`;
        }
    ...
    const onSpeechFinish = () => {
      try {
        window.SceneTimer?.resume?.();
      } catch(_) {}
    };


    const onSpeechCancel = () => {
      try {
        window.SceneTimer?.resume?.();
      } catch(_) {}
    };
    ...
    try {
      ...
      stampChoiceNextTargetsFromScene(
        choicesSrc,
        mcHost
      );
    ...
    const hasFlag = (f) =>
      window.progress &&
      window.progress.flags &&
      !!window.progress.flags[f];


    const isUnlocked = (s) =>
      window.progress &&
      window.progress.unlocked &&
      window.progress.unlocked.has &&
      window.progress.unlocked.has(s);


    // Shared WeakMap for navigation fallbacks

    window.__choiceNextMap =
      window.__choiceNextMap ||
      new WeakMap();
    ...
    (choicesSrc.choices || []).forEach(choice => {
      ...
      btn.style.cssText =
        "text-align:left;padding:10px 12px;border-radius:10px;border:none;background:#00ffff;color:#000;font-weight:700;cursor:pointer";


      btn.onmouseenter = () =>
        (btn.style.background = "#00cccc");
      ...
      regListener(btn, "click", () => {
        ...
        requestAnimationFrame(() => {
          ...
          if (
            ...
            console.warn(
              '[video] choice click swallowed → forcing loadScene:',
              nextTarget,
              { before }
            );
    ...
    regCleanup(() => {
      ...
      const n =
        document.getElementById("video-choices");

      if (n) n.remove();


      const t =
        document.getElementById("video-choices-timer");

      if (t) t.remove();


      const f =
        document.getElementById("video-choices-feedback");
  ...
  // ============================================================
  // ENDED EVENT
  // Original event listener remains unchanged for MP4.
  // YouTube calls onEnded() from its YT state-change event above.
  // ============================================================
...
if (nextId) {
  ...
  try {
    window.unlockScene && window.unlockScene(nextId);
  } catch (_) {}

  setTimeout(() => {

    // Cleanly close the email UI before returning to normal scenes
    const emailUI =
      document.getElementById("email-challenge-container");
...
function loadVideoMultiQuestionScene(id) {
  ...
  function ensureYouTubeAPI() {
    ...
    window.__youtubeIframeApiPromise = new Promise((resolve, reject) => {
      ...
      if (!document.querySelector('script[src="https://www.youtube.com/iframe_api"]')) {
        ...
        tag.onerror = function() {
          console.error("[video-multi-question] YouTube IFrame API failed to load.");
          reject(new Error("YouTube IFrame API failed to load."));
        };
  ...
  const onSpeechFinish = () => {
    try { window.SceneTimer?.resume?.(); } catch(_) {}
  };
  ...
  function finish() {
    ...
    try {
      ...
      if (window.SceneTimer === sceneTimerAPI) {
        ...
        if (prevSceneTimer) {
          window.SceneTimer = prevSceneTimer;
        } else {
          delete window.SceneTimer;
        }
      }
    ...
    if (scene.scoring && scene.endings) {
      ...
      const dest =
        (score >= high)
          ...
          : (
              score >= medium
                ? scene.endings.medium
                : scene.endings.low
            );


      if (dest) {
        return loadScene(dest);
      }
    }
    ...
    console.warn(
      "video-multi-question: No endings or next specified."
    );
  }
  ...
  function startQuestions() {
    ...
    // Prevent replaying the video from creating another question set
    ...
    if (isYouTube) {
      ...
      /*
        IMPORTANT:
        Keep YouTube visible and interactive so the student
        can replay it while answering the questions.
      */

      pauseMedia();

      const skip =
        document.getElementById("vmq-skip-video");
  ...
  function renderQuestion() {
    ...
    if (seconds && seconds > 0) {
      ...
      timerDiv.style.cssText =
        "font-weight:700;font-size:1.1rem;color:#00ffff;margin-top:10px;";
    ...
    const rightTextFromQ =
      q.speechRightText
        ? String(q.speechRightText)
        : null;


    const rightTextFromSceneArr =
      Array.isArray(scene.speechRightTexts)
        ? scene.speechRightTexts[qIndex]
        : null;


    const speechRightText =
      rightTextFromQ ||
      rightTextFromSceneArr ||
      null;


    const speechRightNorm =
      speechRightText
        ? normTxt(speechRightText)
        : null;
    ...
    opts.forEach((opt, i) => {
      ...
      btn.dataset.originIndex =
        String(opt.__originIndex);
      ...
      // 🔔 notify hooks that choices are ready
      try {
      ...
      // 🎤 arm speech for these choices
      try {

        if (
          typeof window.__armSpeechForChoices ===
          'function'
        ) {
      ...
      btn.style.cssText =
        "text-align:left;margin:5px;padding:10px 12px;font-weight:700;background:#00ffff;border:none;border-radius:10px;cursor:pointer;color:#000";
  ...
  if (isYouTube) {
    ...
    youtubeHost.style.cssText =
      "width:100%;height:min(45vh,506px);min-height:240px;display:block;border-radius:12px;background:#000;overflow:hidden;";
    ...
    skipBtn.style.cssText =
      "margin-top:8px;padding:8px 12px;border:none;border-radius:8px;background:#222;color:#eee;cursor:pointer;font-weight:700";
    ...
    ensureYouTubeAPI()
              ...
              events: {
                ...
                onError:
                  function(event) {
                    ...
                    console.warn(
                      "[video-multi-question] YouTube player error:",
                      event.data,
                      "video:",
                      youtubeVideoId
                    );
      ...
      .catch(err => {
        ...
        console.warn(
          "[video-multi-question] YouTube setup failed:",
          err
        );
      });
  ...
  // ============================================================
    ...
    video.style.cssText =
      "width:100%;height:auto;max-height:45vh;display:block;border-radius:12px;background:#000;";
    ...
    overlay.style.cssText =
      "position:absolute;inset:auto 0 0 0;margin:auto;top:0;bottom:0;width:180px;height:48px;background:#00ffff;color:#000;border:none;border-radius:10px;font-weight:700;cursor:pointer";
    ...
    const errorMsg =
      () => {
        ...
        msg.style.cssText =
          "margin-top:8px;color:orange;font-weight:700";

        msg.textContent =
          "⚠️ This device can’t play the video inline.";
        ...
        a.style.cssText =
          "display:inline-block;margin-left:8px;color:#0ff;text-decoration:underline";
...
function loadVideoScrambleScene(id) {
  ...
  // Prevent duplicate scramble UI if YouTube is replayed
  ...
  function ensureYouTubeAPI() {
    ...
    window.__youtubeIframeApiPromise = new Promise((resolve, reject) => {
      ...
      if (!document.querySelector('script[src="https://www.youtube.com/iframe_api"]')) {
        ...
        tag.onerror = function() {
          console.error("[video-scramble] YouTube IFrame API failed to load.");
          reject(new Error("YouTube IFrame API failed to load."));
        };
  ...
  // ============================================================
  // SHOW SCRAMBLE
  // MP4 and YouTube both call this.
  // ============================================================

  function showScrambleChallenge() {
    ...
    const source = Array.isArray(scene.scramble)
      ? scene.scramble.slice()
      : [];
    ...
    try {
      if (
        window.scrambleSortable &&
        typeof window.scrambleSortable.destroy === "function"
      ) {
        window.scrambleSortable.destroy();
      }

      window.scrambleSortable = Sortable.create(
        scrambleContainer,
        { animation: 150 }
      );
    ...
    checkBtn.onclick = () => {
      ...
      const words = Array.from(
        document.querySelectorAll("#scramble-words .scramble-word")
      );

      const userOrder = words.map(
      ...
      const correctArr = Array.isArray(scene.correct)
        ? scene.correct
        : (
            typeof scene.correct === "string"
              ? scene.correct.trim().split(/\s+/)
              : []
          );
  ...
  // ============================================================
  // CLEAR OLD VIDEO
  // Safe for both native <video> and YouTube <div>
  // ============================================================
  ...
  // Remove a stale YouTube scramble skip button if one exists
  const oldSkip = document.getElementById("video-scramble-skip");
  ...
  if (isYouTube) {
    ...
    youtubeHost.style.cssText =
      "max-width:100%;height:min(360px,56.25vw);min-height:220px;display:block;margin:0 auto 20px;border-radius:12px;background:#000;overflow:hidden;";

    const youtubeInner = document.createElement("div");

    youtubeInner.id =
      "youtube-scramble-player-" +
      String(id).replace(/[^a-zA-Z0-9_-]/g, "_");

    youtubeHost.appendChild(youtubeInner);


    // Insert YouTube player into DOM
    if (sceneText && sceneText.parentNode) {

      sceneText.parentNode.insertBefore(
        youtubeHost,
        sceneText.nextSibling
      );

    } else {

      gameContainer.appendChild(youtubeHost);
    }


    // ==========================================================
    // YOUTUBE-ONLY SKIP VIDEO BUTTON
    // ==========================================================

    const skipBtn = document.createElement("button");

    skipBtn.id = "video-scramble-skip";
    skipBtn.textContent = "Skip video";

    skipBtn.style.cssText =
      "display:block;margin:8px auto 16px;padding:8px 12px;border:none;border-radius:8px;background:#222;color:#eee;cursor:pointer;font-weight:700";
    ...
    skipBtn.onclick = () => {
      ...
      // Pause YouTube but keep it visible for replay
      try {
        if (
          youtubePlayer &&
          typeof youtubePlayer.pauseVideo === "function"
      ...
      showScrambleChallenge();
    };


    if (youtubeHost.parentNode) {

      youtubeHost.parentNode.insertBefore(
        skipBtn,
        youtubeHost.nextSibling
      );
    ...
    ensureYouTubeAPI()
      ...
      .then(() => {
        ...
        if (!document.getElementById(youtubeInner.id)) {
          return;
        }
          ...
          youtubeInner.id,
          {
            ...
            events: {
              ...
              onError: function(event) {
                ...
                console.warn(
                  "[video-scramble] YouTube player error:",
                  event.data,
                  "video:",
                  youtubeVideoId
                );
      ...
      .catch(err => {
        ...
        console.warn(
          "[video-scramble] YouTube setup failed:",
          err
        );
      });
  ...
  // ============================================================
    ...
    videoElem.src =
      resolveSrc(scene.videoSrc);

    if (scene.poster) {
      videoElem.poster =
        resolveSrc(scene.poster);
    }

    videoElem.style.cssText =
      "max-width:100%;max-height:360px;display:block;margin:0 auto 20px;border-radius:12px;background:#000;";
    ...
    videoElem.addEventListener(
      ...
      () => {
        ...
        msg.style.cssText =
          "margin-top:8px;color:orange;font-weight:700;text-align:center";
        ...
        a.style.cssText =
          "margin-left:8px;color:#0ff;text-decoration:underline";
    ...
    // Existing native-video end behaviour
    videoElem.onended =
      showScrambleChallenge;
  }
  ...
  // ============================================================
  // CLEANUP
  // Only relevant for YouTube.
  // Native video cleanup is already handled by your normal scene
  // transition logic.
  // ============================================================
  ...
  regCleanup(() => {
    ...
    const skip =
      document.getElementById("video-scramble-skip");
...
function loadVideoFillBlankScene(id) {
  ...
  // Clear stale UI
  ["vfb-wrap","vfb-ui","scene-video"].forEach(x => {
    const n = document.getElementById(x);
    if (n) n.remove();
  });
  ...
  function ensureYouTubeAPI() {
    ...
    window.__youtubeIframeApiPromise = new Promise((resolve, reject) => {
      ...
      if (!document.querySelector('script[src="https://www.youtube.com/iframe_api"]')) {
        ...
        tag.onerror = function() {
          console.error("[video-fill-in-the-blank] YouTube IFrame API failed to load.");
          reject(new Error("YouTube IFrame API failed to load."));
        };
  ...
  function startFIB() {
    ...
    const sentence = Array.isArray(scene.sentence)
      ? scene.sentence.slice()
      : [];

    const blanks = Array.isArray(scene.blanks)
      ? scene.blanks.slice()
      : [];

    const options = Array.isArray(scene.options)
      ? scene.options.slice()
      : [];

    const correct = Array.isArray(scene.correct)
      ? scene.correct.slice()
      : (
          typeof scene.correct === "string"
            ? [scene.correct]
    ...
    const zones = Array.from(
      sentEl.querySelectorAll(".vfb-zone")
    );
    ...
    zones.forEach(zone => {
      ...
      try {
        ...
        const srt = Sortable.create(zone, {
          ...
          onAdd: (evt) => {
            ...
            if (zone.children.length > 1) {
              ...
              Array.from(zone.children).forEach((c,idx) => {
        ...
        console.warn("Sortable missing?", e);
      }
    });
    ...
    checkBtn.onclick = () => {
      ...
      zones.forEach((zone, zi) => {
        ...
        if (zone.children.length === 1) {
          ...
          user.push(
            zone.children[0].textContent.trim()
          );
        ...
        setTimeout(
          () =>
            scene.next
              ? loadScene(scene.next)
              : console.warn(
                  "video-fill-in-the-blank: no next"
                ),
          900
        );
    ...
    regCleanup(() => {
      ...
      const n =
        document.getElementById("vfb-ui");
  ...
  if (isYouTube) {
    ...
    ensureYouTubeAPI()
            ...
            youtubeInner.id,
            {
              ...
              events: {
                ...
                onError: function(event) {
                  ...
                  console.warn(
                    "[video-fill-in-the-blank] YouTube player error:",
                    event.data,
                    "video:",
                    youtubeVideoId
                  );
      ...
      .catch(err => {
        ...
        console.warn(
          "[video-fill-in-the-blank] YouTube setup failed:",
          err
        );
      });
  ...
  regCleanup(() => {
    ...
    const w =
      document.getElementById("vfb-wrap");
